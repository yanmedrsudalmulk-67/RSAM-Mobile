...
-- 12. Enable RLS for site_assets
ALTER TABLE public.site_assets ENABLE ROW LEVEL SECURITY;

-- 13. Policies for site_assets
DROP POLICY IF EXISTS "Allow public read access to site_assets" ON public.site_assets;
CREATE POLICY "Allow public read access to site_assets" ON public.site_assets FOR SELECT USING (true);

DROP POLICY IF EXISTS "Allow authenticated users to insert site_assets" ON public.site_assets;
CREATE POLICY "Allow authenticated users to insert site_assets" ON public.site_assets FOR INSERT WITH CHECK (true);

DROP POLICY IF EXISTS "Allow authenticated users to update site_assets" ON public.site_assets;
